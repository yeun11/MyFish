...
class OrderListRVAdapter (val items : MutableList<String> ) : RecyclerView.Adapter<OrderListRVAdapter.Viewholder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OrderListRVAdapter.Viewholder {
